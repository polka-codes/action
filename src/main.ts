...
async function getTaskFromIssue(issueNumber: number, octokit: ReturnType<typeof github.getOctokit>) {
...
async function createPullRequest(octokit: ReturnType<typeof github.getOctokit>, branchName: string, title: string, body: string) {
  const { owner, repo } = github.context.repo
